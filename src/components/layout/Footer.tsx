      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-5">{f.tagline}</p>
        ...
        <div className="border-t border-slate-700 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} Gojo. {f.copyright}
          </p>
          <p className="text-sm text-slate-500">{f.slogan}</p>
        </div>
      </div>
    </footer>
  );
